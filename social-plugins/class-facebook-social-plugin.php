...
class Facebook_Social_Plugin {
	...
	public static function div_builder( $div_attributes=array() ) {
		...
		if ( array_key_exists( 'class', $div_attributes ) && is_array( $div_attributes['class'] ) ) {
			$classes = array();
		...
		if ( array_key_exists( 'id', $div_attributes ) && is_string( $div_attributes['id'] ) )
			$div .= ' id="' . esc_attr( $div_attributes['id'] ) . '"';
		if ( array_key_exists( 'style', $div_attributes ) && is_string( $div_attributes['style'] ) )
			$div .= ' style="' . esc_attr( $div_attributes['style'] ) . '"';

		// add data-* attributes
		if ( array_key_exists( 'data', $div_attributes ) && is_array( $div_attributes['data'] ) && ! empty( $div_attributes['data'] ) ) {
